...
<<<<<<< HEAD
            ...
            <form >
                  <div class="form-group">
                       <input type="text" name="first_name" class="" placeholder="FULL NAME" required=""/>
                  </div>
                  <div class="form-group">
        ...
        <div class="container"   id="#mysocial-section">
            <div class="col-md-8 contact-left">
                ...
                <section>
                  ...
                  <div class="fbox-icon">
                  <p>
                      <a href="#mysocial-section" onclick="window.open('http://m.me/divineconsultantcom');"><img src="images/msg-icon.png" alt="Messanger" width="150" height="155"/>
                  </a>
                  </p>
                  <p>&nbsp;</p>
                  </div>
                  ...
                  <p><a href="#mysocial-section" onclick="window.open('https://fb.com/divineconsultantcom');">
                   <img src="images/fb-icon.png"  width="150" height="153" alt="Facebook"/>
                  </a></p>
                  <p>&nbsp;</p>
                  </div>
                 ...
                 <a target="_self" href="javascript:void(Tawk_API.toggle())">
                         <img src="images/chat1.png" alt="Chat" width="150" height="155"/>
                 </a>
                  </p>
                  <p>&nbsp;</p>
                  </div>
...
<footer class='footer-top' >
    <div class='col-md-4'>
        <h3> <img src={logo} width='150' height='100' /> </h3>
